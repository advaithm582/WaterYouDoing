...
const questions = [
    ...
    { question: 'Do you have a top load, or front load washer? (Enter top or front)', name: 'washer_type'},
    ...
    { question: 'Do you have a normal, or efficient shower head? (Enter normal or efficient)', name: 'shower_head'},
    ...
    { question: 'How big is your swimming pool, if you have one? (Enter none, small, medium, or large)', name: 'swimming_pool'},
  ];
